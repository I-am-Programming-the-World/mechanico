...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background transition-colors" dir="rtl">
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur transition-[background-color,box-shadow] supports-[backdrop-filter]:bg-card/60">
        <div className="container flex h-16 flex-wrap items-center justify-between gap-4 px-3 sm:px-4">
          <div className="flex items-center gap-4">
            ...
            <nav className="hidden gap-1 md:flex" aria-label="منوی اصلی">
      ...
      <main
        id="main-content"
        className="container mx-auto px-3 py-8 sm:px-4 motion-safe:animate-page-in"
      >
        {children}
      </main>
